...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        ...
        .addStringOption((options) =>
            options.setName("code").setDescription("Check your own code.").setRequired(true)
        ),
    /**
            ...
            function clean(text) {
                if (typeof text === 'string') {
                    text = text
                        ...
                        .replace(/@/g, `@${String.fromCharCode(8203)}`)
                        .replace(new RegExp(client.token), `That is for me to know and you never to find out.`)
                }
                return text;
            }
        }
