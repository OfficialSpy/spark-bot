...
const joinSchema = require("../../Schemas/welcomeSchema");
      ...
      client.channels.cache.get(joinChannel.channelId).send({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(`<:join:995299756467290155> Welcome <@${user.id}> to ${interaction.guild.name}! We hope you enjoy your stay!`)
            .addFields(
              {
